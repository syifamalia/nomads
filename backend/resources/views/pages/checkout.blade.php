    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="col-lg-4">
                ...
                <p class="payment-instructions">Please complete payment before you <br> continue the wonderful trip</p>
                <div class="bank">
                    <div class="bank-item pb-3">
                    <img src="{{ url('frontend/images/ic_bank.png') }}" alt="Icon" class="bank-image">
